...
const HackerStatusModal = ({
  ...
  const onSubmit = (status: HackerApplicationStatus) => {
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription className="space-y-2 py-2">
            <p>
              Accept or reject the hacker&apos;s applications. Can only be done
              once. When the user receives an email, it cannot be undone.
            </p>
            <p className="">
        ...
        <div className="space-y-1">
          ...
          <div
            className={cn(
              ...
              {
                "bg-destructive font-medium text-white dark:bg-destructive":
                  age < 18,
              },
            )}
          >
          ...
          <div className="flex justify-between rounded-md bg-black/10 px-2.5 py-2 dark:bg-white/5">
            ...
            <p
              className={cn({
                ...
                "text-yellow-500 dark:text-yellow-600": status === "waitListed",
              })}
            >
        ...
        {displayBanner.show && (
          <Banner message={displayBanner.message} type={displayBanner.type} />
        )}
        ...
        !displayBanner.show ? (
          <div className="py-2 text-center text-sm text-muted">
            <p>
              Since the user has already received an email, their status cannot
              be updated at this time.
            </p>
            <p className="mb-4 py-2">
              {" "}
              To undo the action, please contact the user and update the status
              manually in the database as needed.
            </p>
...
export default HackerStatusModal;
