...
const InfoRow = ({
  ...
  return (
    <div className="flex flex-col gap-2 rounded-lg px-2 py-2.5 transition-colors hover:bg-foreground/5 sm:flex-row sm:items-center sm:justify-between sm:gap-4 md:gap-8">
